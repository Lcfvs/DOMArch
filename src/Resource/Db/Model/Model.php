...
use \DOMArch\Resource\Db as Db;
use \DOMArch\Resource\Db\Model\Util as Util;
...
abstract class Model extends SimpleModel
{
    ...
    public static function findOne($query = null, array $values = []) {
    ...
    public static function findAll($query = null, array $values = []) {
    ...
    public function archive() {
        return $this
            ->setArchivedAt(\DOMArch\Config::global()->get('REQUEST_TIME'))
            ->save();
    }
    ...
    protected function _error($field, $message) {
    ...
    public function update() {
        $this->_errors = [];
        $request_time = \DOMArch\Config::global()->get('REQUEST_TIME');
